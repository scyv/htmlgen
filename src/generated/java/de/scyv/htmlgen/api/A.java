...
public class A extends AbstractElement {
     ...
     */
    public A setClass(String value) {
     ...
     * @return The current element.
     */
    public A setOnblur(String value) {
     ...
     * @return The current element.
     */
    public A setOnclick(String value) {
