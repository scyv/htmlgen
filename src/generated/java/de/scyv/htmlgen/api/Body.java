...
public class Body extends AbstractElement {
     ...
     */
    public Body setClass(String value) {
     ...
     * @return The current element.
     */
    public Body setId(String value) {
     ...
     * @return The current element.
     */
    public Body setTitle(String value) {
     ...
     * @return The current element.
     */
    public Body setStyle(String value) {
     ...
     * @return The current element.
     */
    public Body setOnblur(String value) {
     ...
     * @return The current element.
     */
    public Body setOnclick(String value) {
