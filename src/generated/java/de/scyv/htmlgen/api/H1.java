...
public class H1 extends AbstractElement {
     ...
     */
    public H1 setClass(String value) {
     ...
     * @return The current element.
     */
    public H1 setTitle(String value) {
     ...
     * @return The current element.
     */
    public H1 setStyle(String value) {
     ...
     * @return The current element.
     */
    public H1 setOnblur(String value) {
     ...
     * @return The current element.
     */
    public H1 setOnclick(String value) {
